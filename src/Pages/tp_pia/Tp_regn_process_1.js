...
//               promoter/ partner who would run the day operations of the proposed
//               Training Centre.
//               <br />
...
//               Funded Programme
//               <br />
//               3. Institutes approved under any Central Government skill training
//               Schemes
//               <br />
...
//               Central or State/ UT government or recognized by University Grants
//               Commission.
//               <br />
...
//               Education.
//               <br />
//               7. Any other institute set up by Central or State/ UT government/
//               Corporates/ CSR Trust/ International Institution.
//               <br />
//               8. In future, if the registration/affiliation of the institute is
//               cancelled for any reason by the respective
//               accrediting/registering/governing authority, then its registration
//               as a training partner of CUTM would also stand cancelled.
//               <br />
//               <br />
...
//               <br /> 6. An organization registered in India, conducting business
//               in the domain of skill development & training, having Permanent
//               Income Tax Account Number (PAN) and Service Tax Registration
//               Number and audited accounts of statements at least for last one
//               year.
//               <br />
//               <br />
//               ON BOARDING PROCEDURE
//               <br />
//               1. All Training Partners are required to submit duly filled in and
//               signed application in the prescribed form along with prescribed
//               application fee
//               <br />
//               2. All supporting documents, as given in the application form
//               shall be submitted along with the application form
//               <br />
//               3. Application may be submitted by online and after submission the
//               acknowledgement with Imported documents will seal and sign. The
//               Same then will be submitted by post, courier or by hand for
//               further action
//               <br />
...
//               <br />
//               Application form for Registration/Affiliation/ Accreditation as a
//               Training Partner/Assessment & Certification may be access at
//               https://cutmams.in
//               <br />
//               <br />
...
//               <br />
//               <br />
//               1. CUTM shall evaluate all applications received, within a period
//               of seven days from the date of receipt of the application.
//               <br />
...
//               training center.
//               <br />
//               2. CUTM expects training partner to have requisite infrastructure.
//               This infrastructure may be owned/leased/organized by training
//               partner.
//               <br />
...
//               <br />
//               2nd Floor, Madhusudhan tower/ Diploma Building, Tower, CIT Campus
//               <br />
...
// export default TpRegnProcess_1;

import * as React from 'react';

export const TpRegnProcess_1 = <div className="container"><section id="step-1" className="form-step">
<h2 className="font-normal" style={{ color: "#00008B" }}>
  Accept T&C
</h2>
<h7 className="text-uppercase" style={{ color: "#00008B" }}>
